...
\include{chapter3} % Estado del arte
\include{chapter3_5} % Estado del arte
\include{chapter4} % Metodos y metodologia
\include{chapter5} % Resultados y analisis
\include{chapter6} % Conclusiones y trabajo futuro
\printnomenclature
%
